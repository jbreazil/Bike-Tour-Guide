...
urlLabel = Ti.UI.createLabel({
  text:'http://www.visitftstevens.com‎/',
  color:'black',
  top:-150,
  left:94
});
...
phoneButton.addEventListener('click', function(){
     Titanium.Platform.openURL('tel:5038611671');
...
urlButton.addEventListener('click', function(){
    Titanium.Platform.openURL('http://www.visitftstevens.com‎/');
